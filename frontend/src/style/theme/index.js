import { commonLight,commonDark } from 'naive-ui';

export const lightThemeOverrides = {
  common: {
    ...commonLight,
  // primaryColor: '#8CABD9', // 主颜色
  //   primaryColorHover: '#8CABD9', // 悬停时的颜色
    // primaryColorPressed: '#1c86ee', // 按下时的颜色
    // primaryColorSuppl: '#63b8ff', // 辅助主颜色
    ...
    "primaryColor": "#949AD7",
    // "primaryColor": "rgb(167,208,238)",
    "primaryColorHover": "#949AD7",
    "primaryColorPressed": "#949AD7",
    "primaryColorSuppl": "#949AD7",
    ...
    "infoColorSuppl": "#4098fc",
    "successColor": "#949AD7",
    "successColorHover": "#949AD7",
    "successColorPressed": "#949AD7",
    "successColorSuppl": "#949AD7",
    "warningColor": "#f0a020",
...
export const darkThemeOverrides = {
  common: {
    ...commonDark,
    // primaryColor: '#ff6347', // 黑暗模式主颜色
    // primaryColorHover: '#ff4500',
    // primaryColorPressed: '#ff2400',
    // primaryColorSuppl: '#ff7f50',
    "name": "common",
    "fontFamily": "v-sans, system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\"",
    "fontFamilyMono": "v-mono, SFMono-Regular, Menlo, Consolas, Courier, monospace",
    "fontWeight": "400",
