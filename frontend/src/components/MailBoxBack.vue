...
import { CloudDownloadRound, ReplyFilled, ForwardFilled ,DeleteOutlineFilled,EmailSharp,AccessTimeOutlined,MarkEmailReadRound,MarkEmailReadFilled,EmailOutlined} from '@vicons/material'
...
const refresh = async () => {
  try {
    ...
    // {
    //   "id": 3,
    //     "message_id": "<tencent_E486E82D38D2E1E2E7102FE905BAB86AE20A@qq.com>",
    //     "source": "bili-w <843145936@qq.com>",
    //     "address": "tmpeyesockman23@wangpl.online",
    //     "raw": "",
    //     "created_at": "2025-01-16 07:25:55",
    //     "checked": false,
    //     "originalSource": "843145936@qq.com",
    //     "subject": "测试 email",
    //     "message": "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=GB18030\"><div><b data-v-6b4acc28=\"\" style=\"color: rgb(51, 54, 57); font-family: poetize-font, sans-serif; text-align: center; background-color: rgb(246, 247, 252);\">tmpeyesockman23@wangpl.online</b></div>",
    //     "text": "tmpeyesockman23@wangpl.online",
    //     "attachments": [
    //
    // ]
    // }
    // console.log("MailBox:curMail:"+JSON.stringify(curMail.value));
  } catch (error) {
